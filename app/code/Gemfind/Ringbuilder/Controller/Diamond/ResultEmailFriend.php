    ...
    public function execute() {
        ...
        if ($data) {
            try {
                ...
                $transport_admin_template = $this->_helper->getEmailTemplate('gemfinddiamondsearch/email/email_friend_email_template_admin');
                if($transport_admin_template=='')
                    $transport_admin_template = 'gemfinddiamondsearch_email_email_friend_email_template_admin';
                ...
                $transport_sender_template = $this->_helper->getEmailTemplate('gemfinddiamondsearch/email/email_friend_email_template_sender');
                if($transport_sender_template=='')
                    $transport_sender_template = 'gemfinddiamondsearch_email_email_friend_email_template_sender';
                ...
                $transport_receiver_template = $this->_helper->getEmailTemplate('gemfinddiamondsearch/email/email_friend_email_template_receiver');
                if($transport_receiver_template=='')
                    $transport_receiver_template = 'gemfinddiamondsearch_email_email_friend_email_template_receiver';
