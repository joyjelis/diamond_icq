...
class CompleteReqInfo extends Action {
    ...
    public function execute() {
        ...
        if ($data) {
            ...
            try {
                ...
                $transport_admin_template = $this->_helper->getEmailTemplate('gemfindringbuilder/email/ringrequest_info_email_template_admin');

                if($transport_admin_template=='')

                    $transport_admin_template = 'gemfindringbuilder_email_ringrequest_info_email_template_admin';
                ...
                $transport_sender_template = $this->_helper->getEmailTemplate('gemfindringbuilder/email/ringrequest_info_email_template_sender');

                if($transport_sender_template=='')

                    $transport_sender_template = 'gemfindringbuilder_email_ringrequest_info_email_template_sender';
