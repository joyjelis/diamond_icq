...
function changemetal(object) {
    require(['jquery'], function($) {
        ...
        window.location.href = window.location.origin + '/ringbuilder/settings/view/path/' + urlstring + '-sku-' + metal;
    });
}
...
function changequality(object) {
    require(['jquery'], function($) {
        ...
        var urlstring = $('#metal_type').find('option:selected').attr('data-id');
        window.location.href = window.location.origin + '/ringbuilder/settings/view/path/' + urlstring + '-sku-' + quality;
    });
}
...
function changecenterstone(object) {
    require(['jquery'], function($) {
        ...
        var urlstring = $('#metal_type').find('option:selected').attr('data-id');
        window.location.href = window.location.origin + '/ringbuilder/settings/view/path/' + urlstring + '-sku-' + centerstone;
    });
}
