...
define([
...
], function (ko, $, _, utils, uiAlert, validator, Element, notification, $t) {
    "use strict";
    ...
    return Element.extend({
        defaults: {
            ...
            previewTmpl: "Customer_Sell/preview",
            dropZone: "[data-role=drop-zone]",
            isLoading: false,
            maxFileCount: ko.observable(10),
            uploaderVisible: ko.observable(true),
            uploaderConfig: {
                dataType: "json",
        ...
        processFile: function (file) {
            ...
            this.observe.call(file, true, ["previewWidth", "previewHeight"]);
        ...
        isFileAllowed: function (file) {
            ...
            _.every(
                [this.isExtensionAllowed(file), this.isSizeExceeded(file)],
                function (value) {
                    result = value;
        ...
        onBeforeFileUpload: function (event, data) {
            ...
            if (allowed.passed) {
                ...
                if (
                    this.aggregatedErrors.length === data.originalFiles.length
                ) {
        ...
        onLoadingStop: function () {
            ...
            if (!this.isMultipleFiles) {
                // only single file upload occurred; use first file's error message
                aggregatedErrorMessages.push(this.aggregatedErrors[0].message);
            } else {
                // construct message from all aggregatedErrors
