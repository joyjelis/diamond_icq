...
{
    const API_URL = "http://www.geoplugin.net/json.gp?ip=";
    ...
    /**
     * @param \Magento\Framework\HTTP\Client\Curl                   $_curl
     * @param \Psr\Log\LoggerInterface                              $_logger
     * @param \Magento\Framework\HTTP\PhpEnvironment\RemoteAddress  $_remoteAddress
    ...
    public function getCountryName()
    {
        try {
            ...
            $url = self::API_URL . $visitorIp;
            $this->_curl->get($url);
            $response = $this->_curl->getBody();
            $ipData = json_decode($response);
            return $ipData->geoplugin_countryName;
        } catch (Exception $e) {
            $this->_logger->error('Customer_Sell ViewModel_User getCountryName', [$e->getMessage()]);
            return false;
        }
    }
    ...
    public function getVisitorIp()
    {
        try {
            ...
            $this->_logger->error('Customer_Sell ViewModel_User getVisitorIp', [$e->getMessage()]);
            return false;
        }
    }
