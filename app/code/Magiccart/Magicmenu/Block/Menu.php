...
class Menu extends \Magento\Catalog\Block\Navigation
{
    ...
    public function drawExtraMenuMobile()
    {
        ...
        if ($count) {
            ...
            foreach ($extMenu as $ext) {
                ...
                $html = $this->getStaticBlock($ext->getExtContent().'-mobile', true);
                ...
                if ($html) {
                    $drawExtraMenu .= '<h2> '. $ext->getName() .'</h2>'.$html; //$drawExtraMenu .= '<div class="level-top-mega">'.$html.'</div>';
                }
                $drawExtraMenu .= '</li>';
                $i++;
                $class = ($i == $count) ? 'last' : '';
    ...
    public function drawExtraMenu()
    {
        ...
        if ($count) {
            ...
            foreach ($extMenu as $ext) {
                ...
                if ($html) {
                    $drawExtraMenu .= $html; //$drawExtraMenu .= '<div class="level-top-mega">'.$html.'</div>';
                }
                $drawExtraMenu .= '</li>';
                $i++;
                $class = ($i == $count) ? 'last' : '';
    ...
    public function getImage($category)
    {
        ...
        if (file_exists($image)) {
            $url = $this->_urlMedia . 'magiccart/magicmenu/images/' . $category->getEntityId() . '.png';
        }
        if ($url) {
    ...
    public function getThumbnail($category)
    {
        ...
        if (file_exists($image)) {
            $url = $this->_urlMedia . 'magiccart/magicmenu/thumbnail/' . $category->getEntityId() . '.png';
        }
        if ($url) {
