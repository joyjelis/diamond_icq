<?php
namespace MageArray\Faq\Block\Adminhtml\Faqcat;

/**
 * Class Grid
 * @package MageArray\Faq\Block\Adminhtml\Faqcat
 */
class Grid extends \Magento\Backend\Block\Widget\Grid\Extended
{

    /**
     * @var \MageArray\Faq\Model\FaqcatFactory
     */
    ...
    {
        $this->setMassactionIdField('faq_cat_id');
