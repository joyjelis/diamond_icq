<?php
namespace MageArray\Faq\Controller;
...
use MageArray\Faq\Model\FaqFactory;
use MageArray\Faq\Model\FaqcatFactory;
...
/**
 * Class Router
 * @package MageArray\Faq\Controller
 */
    ...
    public function match(\Magento\Framework\App\RequestInterface $request)
    {
        if (!$this->dispatched) {
            ...
            $this->eventManager->dispatch(
                'magearray_faq_controller_router_match_before',
