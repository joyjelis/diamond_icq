<?php
namespace Magneto\MagecompExtrafee\Model;
...
class ExtrafeeConfigProvider implements ConfigProviderInterface
{
    ...
    public function getConfig()
    {
        ...
        $this->logger->debug('Override ExtraFee Configprovider using di');
        ...
        $enabled = $this->dataHelper->isModuleEnabled() && $this->myHelper->getIsProductsEngraved($quote);
        ;
